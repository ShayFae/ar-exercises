...
@store1.employees.create(first_name: "Ash", last_name: "Ketchum", hourly_rate: 30)
@store1.employees.create(first_name: "Eren", last_name: "Yeager", hourly_rate: 20)
...
@store2.employees.create(first_name: "Berry", last_name: "Allen", hourly_rate: 20)
@store2.employees.create(first_name: "Peter", last_name: "Parker", hourly_rate: 40)
@store2.employees.create(first_name: "Kamala", last_name: "Khan", hourly_rate: 30)
